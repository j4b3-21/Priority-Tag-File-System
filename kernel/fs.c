...
static void ptfs_format_tags(struct inode *ip, char *out, int outlen) {
  int outpos = 0;
...
static void ptfs_dump_file_blocks(struct inode *ip, const char *path) {
...
static void ptfs_dump_tree(struct inode *dp, char *path) {
  struct dirent de;
