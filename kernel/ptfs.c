...
static int is_single_block_file(struct inode *ip) {
...
static void swap_single_block_files(struct inode *a, struct inode *b) {
...
static void collect_file_inodes(struct inode *dp, struct inode **out, int *n,
                                int max) {
  struct dirent de;
